...
struct Memory::Impl {
    ...
    void SetCurrentPageTable(Kernel::Process& process, u32 core_id, bool force) {
...
void Memory::SetCurrentPageTable(Kernel::Process& process, u32 core_id, bool force) {
    impl->SetCurrentPageTable(process, core_id, force);
}
