...
private:
    static constexpr inline std::size_t MemoryBlockPageShifts[]{0xC,  0x10, 0x15, 0x16,
                                                                0x19, 0x1D, 0x1E};
...
public:
    static constexpr s32 GetAlignedBlockIndex(std::size_t num_pages, std::size_t align_pages) {
        ...
        for (std::size_t i{}; i < NumMemoryBlockPageShifts; i++) {
...
private:
    ...
    private:
        ...
        public:
            ...
            constexpr s64 FindFreeBlock() const {
                uintptr_t offset{};
                s32 depth{};
                ...
                do {
                    ...
                    offset = offset * 64 + __builtin_ctzll(v);
                    ++depth;
...
private:
    void Initialize(VAddr heap_address, std::size_t heap_size, std::size_t metadata_size,
                    const std::size_t* block_shifts, std::size_t num_block_shifts);

    constexpr std::size_t GetNumFreePages() const {
        std::size_t num_free{};

        for (std::size_t i{}; i < num_blocks; i++) {
            num_free += blocks[i].GetNumFreePages();
        }
...
public:
    ...
    void Initialize(VAddr heap_address, std::size_t heap_size, std::size_t metadata_size) {
        return Initialize(heap_address, heap_size, metadata_size, MemoryBlockPageShifts,
...
private:
    static std::size_t CalculateMetadataOverheadSize(std::size_t region_size,
                                                     const std::size_t* block_shifts,
                                                     std::size_t num_block_shifts);

public:
    static std::size_t CalculateMetadataOverheadSize(std::size_t region_size) {
        return CalculateMetadataOverheadSize(region_size, MemoryBlockPageShifts,
                                             NumMemoryBlockPageShifts);
    }
};
