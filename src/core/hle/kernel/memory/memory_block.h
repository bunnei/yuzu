...
enum class MemoryState : u32 {
    ...
    Io = Svc::MemoryState_Io | FlagMapped,
    Static = Svc::MemoryState_Static | FlagMapped | FlagCanQueryPhysical,
    Code = Svc::MemoryState_Code | FlagsCode | FlagCanMapProcess,
    CodeData = Svc::MemoryState_CodeData | FlagsData | FlagCanMapProcess | FlagCanCodeMemory,
    Normal = Svc::MemoryState_Normal | FlagsData | FlagCanCodeMemory,
    Shared = Svc::MemoryState_Shared | FlagMapped | FlagReferenceCounted,

    AliasCode = Svc::MemoryState_AliasCode | FlagsCode | FlagCanMapProcess | FlagCanCodeAlias,
    AliasCodeData = Svc::MemoryState_AliasCodeData | FlagsData | FlagCanMapProcess |
                    FlagCanCodeAlias | FlagCanCodeMemory,

    Ipc = Svc::MemoryState_Ipc | FlagsMisc | FlagCanAlignedDeviceMap | FlagCanUseIpc |
          FlagCanUseNonSecureIpc | FlagCanUseNonDeviceIpc,

    Stack = Svc::MemoryState_Stack | FlagsMisc | FlagCanAlignedDeviceMap | FlagCanUseIpc |
            FlagCanUseNonSecureIpc | FlagCanUseNonDeviceIpc,

    ThreadLocal = Svc::MemoryState_ThreadLocal | FlagMapped | FlagReferenceCounted,

    Transfered = Svc::MemoryState_Transfered | FlagsMisc | FlagCanAlignedDeviceMap |
                 FlagCanChangeAttribute | FlagCanUseIpc | FlagCanUseNonSecureIpc |
                 FlagCanUseNonDeviceIpc,

    SharedTransfered = Svc::MemoryState_SharedTransfered | FlagsMisc | FlagCanAlignedDeviceMap |
                       FlagCanUseNonSecureIpc | FlagCanUseNonDeviceIpc,

    SharedCode = Svc::MemoryState_SharedCode | FlagMapped | FlagReferenceCounted |
                 FlagCanUseNonSecureIpc | FlagCanUseNonDeviceIpc,

    Inaccessible = Svc::MemoryState_Inaccessible,

    NonSecureIpc = Svc::MemoryState_NonSecureIpc | FlagsMisc | FlagCanAlignedDeviceMap |
                   FlagCanUseNonSecureIpc | FlagCanUseNonDeviceIpc,

    NonDeviceIpc = Svc::MemoryState_NonDeviceIpc | FlagsMisc | FlagCanUseNonDeviceIpc,

    Kernel = Svc::MemoryState_Kernel | FlagMapped,

    GeneratedCode =
        Svc::MemoryState_GeneratedCode | FlagMapped | FlagReferenceCounted | FlagCanDebug,
    CodeOut = Svc::MemoryState_CodeOut | FlagMapped | FlagReferenceCounted,
};
...
enum class MemoryPermission : u8 {
    ...
    UserMask =
        Svc::MemoryPermission_Read | Svc::MemoryPermission_Write | Svc::MemoryPermission_Execute,
};
...
enum class MemoryAttribute : u8 {
    ...
    Locked = Svc::MemoryAttribute_Locked,
    IpcLocked = Svc::MemoryAttribute_IpcLocked,
    DeviceShared = Svc::MemoryAttribute_DeviceShared,
    Uncached = Svc::MemoryAttribute_Uncached,
